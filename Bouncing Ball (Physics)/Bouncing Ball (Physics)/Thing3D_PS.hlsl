...
//**************************************************************************//
// The pixel shader for the flat thing. This uses a different texture, and	//
...
//**************************************************************************//
// The pixel shader for a Thing3D with no texture//							//
//**************************************************************************//
float4 Thing3DNoTexture( VS_OUTPUT In ) : SV_Target
{ 
    return MaterialDiffuseColor * dot(vecLightDir, In.vecNormal) + 0.2;
}
