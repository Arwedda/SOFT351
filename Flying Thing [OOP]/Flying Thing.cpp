...
float		ground				= 0.0;
float		gravityFallSpeed	= 9.8 / 1000000;	//Gravity fall speed with scaling (since 9.8 m/frame/frame seems too fast)
...
void RenderText()
{
	...
	if (g_bShowHelp)
	{
		...
		g_pTxtHelper->DrawTextLine(L"Move model: W /S keys\n");
